        ...
        options: [
            {
                ...
                points: 5,
                impact: "Scenario 1 Option 1:Safety-first algorithms prioritize the well-being of all, aligning with ethical values."
            },
            {
                ...
                points: 3,
                impact: "Scenario 1 Option 2:Passenger-centric algorithms may raise ethical concerns about the safety of others."
            },
            {
                ...
                points: 2,
                impact: "Scenario 1 Option 3:Passenger choice may raise moral dilemmas and ethical complexities."
            }
        ]
    },
    {
        ...
        options: [
            {
                ...
                points: 5,
                impact: "Scenario 2 Option 1:Strong data protection measures align with ethical standards and safeguard user privacy."
            },
            {
                ...
                points: 2,
                impact: "Scenario 2 Option 2:Minimal data protection may raise ethical concerns about data privacy."
            },
            {
                text: "Option 3: Share user data with third parties without consent, disregarding ethical principles and privacy norms.",
                points: 1,
                impact: "Scenario 2 Option 3:Sharing data without consent violates ethical standards and privacy norms."
            }
        ]
    },
    {
        ...
        options: [
            {
                ...
                points: 5,
                impact: "Scenario 3 Option 1:Retraining programs and support demonstrate ethical responsibility and address job displacement concerns."
            },
            {
                ...
                points: 2,
                impact: "Scenario 3 Option 2:Failure to address job displacement may lead to public outrage and ethical issues."
            },
            {
                ...
                points: 1,
                impact: "Scenario 3 Option 3:Prioritizing automation without addressing job displacement may raise ethical concerns."
            }
        ]
    }
];
